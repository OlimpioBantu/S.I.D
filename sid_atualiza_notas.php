	...
	if(isset($_POST["btnAlterar"]))  //alterando um registro
	{
	   ...
	   $sql = "UPDATE notas_disciplinas
	           SET matr_aluno ='".$matr_aluno."', notas_discip ='".$notas_discip."',cod_discip ='".$cod_discip."'
					WHERE matr_aluno =".$matr_aluno . " and cod_discip=".$cod_discip;
...
?>
	<h3 align="middle">			R.A do Aluno :
		<input type="text" name="matr_aluno" size="3" maxlength="6" value="<?php echo $matr_aluno; ?>">
	...
	<h3 align="middle">			Código da Diciplina:
		<input type="number" size="3" maxlength="6" name="cod_discip"  value="<?php echo $_GET["$cod_discip"];?>">	
		<br>								
		<br>
		<br>
	...
	<link rel="stylesheet" href="sid_atualiza_notas.php" media="all"/><p>
		...
		<br> <br>
<input type="button" onClick="document.location='sid_lista_aluno.php'" value="  Check  " ><br />	
<br/>   <br>
